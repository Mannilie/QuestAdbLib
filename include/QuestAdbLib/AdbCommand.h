...
namespace QuestAdbLib {
    ...
    class QUESTADBLIB_API AdbCommand {
      public:
        ...
        Result<std::string> runWithProgress(const std::string& command,
        ...
        Result<std::string> shell(const std::string& deviceId, const std::string& command,
                                  bool capture = true);
        Result<bool> push(const std::string& deviceId, const std::string& localPath,
                          const std::string& remotePath);
        Result<bool> pull(const std::string& deviceId, const std::string& remotePath,
                          const std::string& localPath);
        Result<bool> broadcast(const std::string& deviceId, const std::string& action,
