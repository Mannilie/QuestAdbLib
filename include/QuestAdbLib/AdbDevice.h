...
namespace QuestAdbLib {
    ...
    private:
        ...
        static constexpr const char* DEVICE_METRICS_PATH = "/sdcard/Android/data/com.oculus.ovrmonitormetricsservice/files/CapturedMetrics";
        static constexpr const char* METRICS_SERVICE_COMPONENT = "com.oculus.ovrmonitormetricsservice/.SettingsBroadcastReceiver";
    };
